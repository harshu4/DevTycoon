...
const vidoes = ["https://media.thetavideoapi.com/video_92is9xveiyzr4wcpcehbrv3z1p/master.m3u8","https://media.thetavideoapi.com/video_bmikzk59q5d8b46wxk1bwrqnss/master.m3u8","https://media.thetavideoapi.com/video_68jpk00pjuvak27wc4rv5xh117/master.m3u8","https://media.thetavideoapi.com/video_e3mu0sq1kq5tepnypquk5nkmip/master.m3u8","https://media.thetavideoapi.com/video_pjrb8zciwg5emx715z11msy2p0/master.m3u8","https://media.thetavideoapi.com/video_cq5bfa2rfctexiawg5q0cib55w/master.m3u8","https://media.thetavideoapi.com/video_cgy24gep2py42d9cv7u9zb2nkf/master.m3u8"]
const contract_address = "0x3063884f11A006A8cDfDc716a309382Caae1D434"
...
function startVideo(){
    try{
        $("body").append(`<video  style="margin-left: auto; margin-right: auto; position: absolute; left:0;right:0;" id="my-player" ></video>`)
        isVideoInit = true;
...
$("#metamask-btn").click(async ()=>{
    ...
    if(isWeb3Available){
        ...
        if(chain_id!=365){
            Core.addToShowcase("Please switch to Theta test network!")
            return;
        }
        $("#metamask-btn").hide();
        Core.addToShowcase("Fetching user details from theta network...")
        let notfirst = false;
        setInterval(async ()=>{
            if(notfirst){
                notfirst=true;
